...
این لیستی از مدل‌هایی است که داده‌های آن‌ها را در نظارت نمایش می‌دهیم. اگر مدل شما در این لیست ذکر نشده است، لطفاً از طریق ایمیل support@bullpool.io یا کانال تلگرام @bullpool_support با ما تماس بگیرید.
